...
IF(NOT DEFINED _BASIC_MACROS_CMAKE_)
	...
	SET(_replace_pattern "${attr_name}[ \t]*${setting_sign}(.*)\r.*")

	FILE(READ ${setting_file} _txt_content)
	STRING(REGEX MATCH "${_find_pattern}" _matched_line "${_txt_content}")
	# MESSAGE("### attr_name=${attr_name} _matched_line=${_matched_line}")
	IF (_matched_line)
