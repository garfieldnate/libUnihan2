...
- Changed:
  ...
  + pinyin_strip_tone() and zhuYin_strip_tone()  now return 0 if tone of pinyin/zhuyin is not specified.
  + Doxyfile is renamed as Doxygen.in, so no need to manually modified the  version number.
