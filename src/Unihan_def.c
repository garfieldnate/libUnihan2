...
const FieldProperties *UNIHAN_FIELD_PROPERTIES[UNIHAN_FIELDS_COUNT+1]={
    ...
    {"kAccountingNumeric", UNIHAN_FIELD_FLAG_INTEGER},
    ...
    {"kGB8",  UNIHAN_FIELD_FLAG_INTEGER | UNIHAN_FIELD_FLAG_HEXDECIMAL_16},
    {"kGradeLevel",  UNIHAN_FIELD_FLAG_INTEGER},
    {"kGSR", UNIHAN_FIELD_FLAG_LOWERCASE},
    {"kHangul", 0},
    {"kHanYu", 0},
    {"kHanyuPinlu", UNIHAN_FIELD_FLAG_LOWERCASE},
    {"kHDZRadBreak", 0},
    {"kHKGlyph", 0},
    {"kHKSCS", UNIHAN_FIELD_FLAG_INTEGER | UNIHAN_FIELD_FLAG_HEXDECIMAL_16},
    {"kIBMJapan", UNIHAN_FIELD_FLAG_INTEGER | UNIHAN_FIELD_FLAG_HEXDECIMAL},
    {"kIICore", 0},
    {"kIRGDaeJaweon", 0},
    {"kIRGDaiKanwaZiten", 0},
    {"kIRGHanyuDaZidian", 0},
