...
const FieldProperties *UNIHAN_FIELD_PROPERTIES[UNIHAN_FIELDS_COUNT+1]={
    ...
    {"kAccountingNumeric", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX},
    {"kBigFive", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kCangjie", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kCantonese", UNIHAN_FIELDFLAG_LOWERCASE},
    {"kCCCII",  UNIHAN_FIELDFLAG_UPPERCASE},
    {"kCheungBauer",  UNIHAN_FIELDFLAG_UPPERCASE},
    {"kCheungBauerIndex", 0},
    {"kCihaiT", 0},
    {"kCNS1986", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kCNS1992", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kCompatibilityVariant", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_UCS4 },
    {"kCowles", 0},
    {"kDaeJaweon", 0},
    {"kDefinition", UNIHAN_FIELDFLAG_NO_INDEX},
    {"kEACC", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kFenn", 0},
    {"kFennIndex", 0},
    {"kFourCornerCode", 0},
    {"kFrequency", UNIHAN_FIELDFLAG_INTEGER},
    {"kGB0",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kGB1",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kGB3",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kGB5",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kGB7",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kGB8",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    {"kGradeLevel",  UNIHAN_FIELDFLAG_INTEGER},
    {"kGSR", UNIHAN_FIELDFLAG_LOWERCASE},
    {"kHangul", 0},
    {"kHanYu", 0},
    {"kHanyuPinlu", UNIHAN_FIELDFLAG_PSEUDO | UNIHAN_FIELDFLAG_LOWERCASE},
    {"kHDZRadBreak", 0},
    {"kHKGlyph", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    {"kHKSCS", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kIBMJapan", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kIICore", 0},
    {"kIRGDaeJaweon", 0},
    {"kIRGDaiKanwaZiten", 0},
    {"kIRGHanyuDaZidian", 0},
    ...
    {"kJIS0213", 0},
    {"kJis0", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    {"kJis1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    {"kKangXi", 0},
    {"kKarlgren", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kKorean", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kKPS0", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kKPS1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kKSC0", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    {"kKSC1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    {"kLau", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    {"kMainlandTelegraph", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    ...
    {"kOtherNumeric", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX},
    {"kPhonetic", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kPrimaryNumeric", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX},
    {"kPseudoGB1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXDECIMAL_16},
    ...
    {"kTaiwanTelegraph", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    {"kTang", 0},
    {"kTotalStrokes", UNIHAN_FIELDFLAG_INTEGER},
    ...
    {"dict_page_0_padded_4", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4  | UNIHAN_FIELDFLAG_NO_INDEX},
    {"dict_position", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX},
    {"dict_virtual", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX},
    {"dict_variant_serial", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_2  | UNIHAN_FIELDFLAG_NO_INDEX},
    {"dict_unencoded", UNIHAN_FIELDFLAG_INTEGER},

    {"IRG_GSource", UNIHAN_FIELDFLAG_UPPERCASE },
    {"IRG_HSource", UNIHAN_FIELDFLAG_UPPERCASE },
    {"IRG_JSource", UNIHAN_FIELDFLAG_UPPERCASE },
    {"IRG_KPSource", UNIHAN_FIELDFLAG_UPPERCASE },
    {"IRG_KSource", UNIHAN_FIELDFLAG_UPPERCASE },
    {"IRG_TSource", UNIHAN_FIELDFLAG_UPPERCASE },
    {"IRG_USource", UNIHAN_FIELDFLAG_UPPERCASE },
    {"IRG_VSource", UNIHAN_FIELDFLAG_UPPERCASE },
    {"IRG_source_mapping", UNIHAN_FIELDFLAG_NO_INDEX},
