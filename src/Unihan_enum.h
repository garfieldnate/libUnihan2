...
typedef enum{
    ...
    UNIHAN_RANGE_CJK_UNIFIED_IDEOGRAPHS_EXT_A,
    UNIHAN_RANGE_CJK_UNIFIED_IDEOGRAPHS,
    UNIHAN_RANGE_CJK_UNIFIED_IDEOGRAPHS_4_1,
    UNIHAN_RANGE_CJK_UNIFIED_IDEOGRAPHS_5_1,
    UNIHAN_RANGE_CJK_COMPATIBILITY_UNIFIED_IDEOGRAPHS_A,
    UNIHAN_RANGE_CJK_COMPATIBILITY_UNIFIED_IDEOGRAPHS_B,
    UNIHAN_RANGE_CJK_COMPATIBILITY_UNIFIED_IDEOGRAPHS_4_1,
    UNIHAN_RANGE_CJK_UNIFIED_IDEOGRAPHS_EXT_B,
    UNIHAN_RANGE_CJK_COMPATIBILITY_SUPPLEMENT
} UnihanRange;
/**
