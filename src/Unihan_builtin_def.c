 ...
 */
const UnihanPseudoFieldImportFormat PSEUDO_FIELD_IMPORT_FORMAT[]={
...
UnihanPseudoFieldImportFormatPost PSEUDO_FIELD_IMPORT_FORMAT_POST[]={
    {UNIHAN_FIELD_kSEMANTICVARIANT, UNIHAN_TABLE_kSEMANTICVARIANT_EXTRA,
 ...
 * Public Fields
 */
UnihanPublicFieldExportFormat UNIHAN_PUBLIC_FIELD_EXPORT_FORMAT[]={
    /* Public Fields */
    {UNIHAN_FIELD_CODE,
	{
