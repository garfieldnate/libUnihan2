...
const UnihanFieldTablePair REALFIELD_TABLES[]={
    ...
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_GSOURCE},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_GSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,		UNIHAN_TABLE_IRG_GSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_HSOURCE},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_HSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,		UNIHAN_TABLE_IRG_HSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_JSOURCE},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_JSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,		UNIHAN_TABLE_IRG_JSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_KPSOURCE},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_KPSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,		UNIHAN_TABLE_IRG_KPSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_KSOURCE},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_KSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,		UNIHAN_TABLE_IRG_KSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_TSOURCE},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_TSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,		UNIHAN_TABLE_IRG_TSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_USOURCE},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_USOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,		UNIHAN_TABLE_IRG_USOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_VSOURCE},
    {UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,	UNIHAN_TABLE_IRG_VSOURCE_EXTRA},
...
const UnihanImportData PSEUDOFIELD_IMPORT_DATA[]={
    ...
    {UNIHAN_FIELD_kMANDARIN,	UNIHAN_TABLE_kMANDARIN,
	"([^[:digit:]]*)([1-5])",
	{UNIHAN_FIELD_PINYIN_BASE, UNIHAN_FIELD_PINYIN_TONE, UNIHAN_FIELD_SERIAL_NO_JOIN,
	    UNIHAN_INVALID_FIELD},
	{"$1","$2","$+", NULL}
    },
...
const UnihanReferenceTableField PSEUDOFIELDS_REQUIRED[]={
    ...
    {UNIHAN_FIELD_kIRG_GSOURCE, UNIHAN_TABLE_IRG_GSOURCE, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_GSOURCE, UNIHAN_TABLE_IRG_GSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_GSOURCE, UNIHAN_TABLE_IRG_GSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_MAPPING},
    {UNIHAN_FIELD_kIRG_HSOURCE, UNIHAN_TABLE_IRG_HSOURCE, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME,
    {UNIHAN_FIELD_kIRG_HSOURCE, UNIHAN_TABLE_IRG_HSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_HSOURCE, UNIHAN_TABLE_IRG_HSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_MAPPING},
    {UNIHAN_FIELD_kIRG_JSOURCE, UNIHAN_TABLE_IRG_JSOURCE, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_JSOURCE, UNIHAN_TABLE_IRG_JSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_JSOURCE, UNIHAN_TABLE_IRG_JSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_MAPPING},
    {UNIHAN_FIELD_kIRG_KPSOURCE,  UNIHAN_TABLE_IRG_KPSOURCE, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_KPSOURCE,  UNIHAN_TABLE_IRG_KPSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_KPSOURCE,  UNIHAN_TABLE_IRG_KPSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_MAPPING},
    {UNIHAN_FIELD_kIRG_KSOURCE, UNIHAN_TABLE_IRG_KSOURCE, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_KSOURCE, UNIHAN_TABLE_IRG_KSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_KSOURCE, UNIHAN_TABLE_IRG_KSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_MAPPING},
    {UNIHAN_FIELD_kIRG_TSOURCE, UNIHAN_TABLE_IRG_TSOURCE, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_TSOURCE, UNIHAN_TABLE_IRG_TSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_TSOURCE, UNIHAN_TABLE_IRG_TSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_MAPPING},
    {UNIHAN_FIELD_kIRG_USOURCE, UNIHAN_TABLE_IRG_USOURCE, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_USOURCE, UNIHAN_TABLE_IRG_USOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_USOURCE, UNIHAN_TABLE_IRG_USOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_MAPPING},
    {UNIHAN_FIELD_kIRG_VSOURCE, UNIHAN_TABLE_IRG_VSOURCE, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_VSOURCE, UNIHAN_TABLE_IRG_VSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_SHORT_NAME},
    {UNIHAN_FIELD_kIRG_VSOURCE, UNIHAN_TABLE_IRG_VSOURCE_EXTRA, UNIHAN_FIELD_IRG_SOURCE_MAPPING},
    ...
    {UNIHAN_FIELD_kMANDARIN,	UNIHAN_TABLE_kMANDARIN, UNIHAN_FIELD_SERIAL_NO_JOIN},
    ...
    {UNIHAN_FIELD_kSPECIALIZEDSEMANTICVARIANT, UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT_EXTRA,
	UNIHAN_FIELD_SPECIALIZEDSEMANTIC_T},
    {UNIHAN_FIELD_kSPECIALIZEDSEMANTICVARIANT, UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT_EXTRA,
       	UNIHAN_FIELD_SPECIALIZEDSEMANTIC_B},
