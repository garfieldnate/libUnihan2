...
const UnihanFieldProperties UNIHAN_FIELD_PROPERTIES[]={
    ...
    {"kAccountingNumeric", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kBigFive", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kCangjie", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kCantonese", UNIHAN_FIELDFLAG_LOWERCASE},
    {"kCCCII",  UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kCheungBauer",  UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kCheungBauerIndex", 0},
    {"kCihaiT", 0},
    {"kCNS1986", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kCNS1992", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kCompatibilityVariant", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_UCS4 },
    {"kCowles", 0},
    {"kDaeJaweon", 0},
    {"kDefinition", UNIHAN_FIELDFLAG_NO_INDEX | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kEACC", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16},
    {"kFenn", 0},
    {"kFennIndex", 0},
    {"kFourCornerCode", UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kFrequency", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kGB0",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kGB1",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kGB3",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kGB5",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kGB7",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kGB8",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kGradeLevel",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kGSR", UNIHAN_FIELDFLAG_LOWERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kHangul", 0},
    {"kHanYu", 0},
    {"kHanyuPinlu", UNIHAN_FIELDFLAG_LOWERCASE},
    {"kHDZRadBreak", 0},
    {"kHKGlyph", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    {"kHKSCS", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kIBMJapan", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kIICore", UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kIRGDaeJaweon", 0},
    {"kIRGDaiKanwaZiten", 0},
    {"kIRGHanyuDaZidian", 0},
    {"kIRGKangXi", 0},
    ...
    {"kJIS0213", 0},
    {"kJis0", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kJis1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kKangXi", 0},
    {"kKarlgren", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kKorean", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kKPS0", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kKPS1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kKSC0", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kKSC1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kLau", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16},
    {"kMainlandTelegraph", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    ...
    {"kOtherNumeric", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kPhonetic", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kPrimaryNumeric", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kPseudoGB1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    ...
    {"kTaiwanTelegraph", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kTang", 0},
    {"kTotalStrokes", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"kTraditionalVariant", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_UCS4},
    {"kVietnamese", 0},
    {"kXerox",  UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    ...
    {"IRG_GSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"IRG_HSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"IRG_JSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"IRG_KPSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"IRG_KSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"IRG_TSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"IRG_USource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
    {"IRG_VSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELDFLAG_SINGLETON | UNIHAN_FIELDFLAG_NO_PRIMARYKEY},
...
const UnihanFieldTablePair REALFIELD_TABLES[]={
    ...
    {UNIHAN_FIELD_DICT_PAGE,		UNIHAN_TABLE_kSBGY},
    {UNIHAN_FIELD_DICT_POSITION,	UNIHAN_TABLE_kSBGY},
 ...
 */
const UnihanPseudoFieldImportFormat PSEUDOFIELD_IMPORT_FORMAT[]={
    {UNIHAN_FIELD_kDAEJAWEON, UNIHAN_TABLE_kDAEJAWEON,
	"([[:digit:]]*)\\.([[:digit:]]*)([0158])",
   ...
   {UNIHAN_FIELD_kIRGHANYUDAZIDIAN, UNIHAN_TABLE_kIRGHANYUDAZIDIAN,
    ...
    {UNIHAN_FIELD_kSBGY, UNIHAN_TABLE_kSBGY,
	"([[:digit:]]*)\\.([[:digit:]]*)",
	{UNIHAN_FIELD_DICT_PAGE, UNIHAN_FIELD_DICT_POSITION,
	    UNIHAN_INVALID_FIELD},
	{"$1","$2", NULL}
    },
    {UNIHAN_FIELD_kSEMANTICVARIANT, UNIHAN_TABLE_kSEMANTICVARIANT,
...
UnihanPseudoFieldImportFormatPost PSEUDOFIELD_IMPORT_FORMAT_POST[]={
    {UNIHAN_FIELD_kSEMANTICVARIANT, UNIHAN_TABLE_kSEMANTICVARIANT_EXTRA,
 ...
 * Exporting Format
 */
UnihanPseudoFieldExportFormat UNIHAN_PSEUDOFIELD_EXPORT_FORMAT[]={
