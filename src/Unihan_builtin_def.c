...
const UnihanFieldProperties UNIHAN_FIELD_PROPERTIES[]={
    {"code", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_UCS4 },
    {"kAccountingNumeric", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kBigFive", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kCangjie", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kCantonese", UNIHAN_FIELDFLAG_LOWERCASE},
    {"kCCCII",  UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kCheungBauer",  UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kCheungBauerIndex", 0},
    {"kCihaiT", 0},
    {"kCNS1986", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kCNS1992", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kCompatibilityVariant", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_UCS4 },
    {"kCowles", 0},
    {"kDaeJaweon", 0},
    {"kDefinition", UNIHAN_FIELDFLAG_NO_INDEX | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kEACC", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16},
    {"kFenn", 0},
    {"kFennIndex", 0},
    {"kFourCornerCode", UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kFrequency", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kGB0",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kGB1",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kGB3",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kGB5",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kGB7",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kGB8",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kGradeLevel",  UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kGSR", UNIHAN_FIELDFLAG_LOWERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kHangul", 0},
    {"kHanYu", 0},
    {"kHanyuPinlu", UNIHAN_FIELDFLAG_LOWERCASE},
    {"kHDZRadBreak", 0},
    {"kHKGlyph", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4},
    {"kHKSCS", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kIBMJapan", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kIICore", UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kIRGDaeJaweon", 0},
    {"kIRGDaiKanwaZiten", 0},
    {"kIRGHanyuDaZidian", 0},
    {"kIRGKangXi", 0},
    ...
    {"kJIS0213", 0},
    {"kJis0", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kJis1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kKangXi", 0},
    {"kKarlgren", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kKorean", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kKPS0", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kKPS1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kKSC0", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kKSC1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kLau", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16},
    {"kMainlandTelegraph", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    ...
    {"kOtherNumeric", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kPhonetic", UNIHAN_FIELDFLAG_UPPERCASE},
    {"kPrimaryNumeric", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_NO_INDEX | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kPseudoGB1", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_HEXADECIMAL_16 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    ...
    {"kTaiwanTelegraph", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_0_PADDED_4 | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kTang", 0},
    {"kTotalStrokes", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"kTraditionalVariant", UNIHAN_FIELDFLAG_INTEGER | UNIHAN_FIELDFLAG_UCS4},
    {"kVietnamese", 0},
    {"kXerox",  UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    ...
    {"IRG_GSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"IRG_HSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"IRG_JSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"IRG_KPSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"IRG_KSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"IRG_TSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"IRG_USource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
    {"IRG_VSource", UNIHAN_FIELDFLAG_UPPERCASE | UNIHAN_FIELD_FLAG_SINGLETON | UNIHAN_FIELD_FLAG_NO_PRIMARYKEY},
...
const UnihanFieldTablePair REALFIELD_TABLES[]={
    ...
    {UNIHAN_FIELD_IRG_GSOURCE,		UNIHAN_TABLE_kIRG_GSOURCE},
    {UNIHAN_FIELD_IRG_GSOURCE,		UNIHAN_TABLE_kIRG_GSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,	UNIHAN_TABLE_kIRG_GSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_HSOURCE,		UNIHAN_TABLE_kIRG_HSOURCE},
    {UNIHAN_FIELD_IRG_HSOURCE,		UNIHAN_TABLE_kIRG_HSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,	UNIHAN_TABLE_kIRG_HSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_JSOURCE,		UNIHAN_TABLE_kIRG_JSOURCE},
    {UNIHAN_FIELD_IRG_JSOURCE,		UNIHAN_TABLE_kIRG_JSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,	UNIHAN_TABLE_kIRG_JSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_KPSOURCE,		UNIHAN_TABLE_kIRG_KPSOURCE},
    {UNIHAN_FIELD_IRG_KPSOURCE,		UNIHAN_TABLE_kIRG_KPSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,	UNIHAN_TABLE_kIRG_KPSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_KSOURCE,		UNIHAN_TABLE_kIRG_KSOURCE},
    {UNIHAN_FIELD_IRG_KSOURCE,		UNIHAN_TABLE_kIRG_KSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,	UNIHAN_TABLE_kIRG_KSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_TSOURCE,		UNIHAN_TABLE_kIRG_TSOURCE},
    {UNIHAN_FIELD_IRG_TSOURCE,		UNIHAN_TABLE_kIRG_TSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,	UNIHAN_TABLE_kIRG_TSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_USOURCE,		UNIHAN_TABLE_kIRG_USOURCE},
    {UNIHAN_FIELD_IRG_USOURCE,		UNIHAN_TABLE_kIRG_USOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,	UNIHAN_TABLE_kIRG_USOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_VSOURCE,		UNIHAN_TABLE_kIRG_VSOURCE},
    {UNIHAN_FIELD_IRG_VSOURCE,		UNIHAN_TABLE_kIRG_VSOURCE_EXTRA},
    {UNIHAN_FIELD_IRG_SOURCE_MAPPING,	UNIHAN_TABLE_kIRG_VSOURCE_EXTRA},
    ...
    {UNIHAN_FIELD_SPECIALIZEDSEMANTICVARIANT,		UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT},
    {UNIHAN_FIELD_SPECIALIZEDSEMANTICVARIANT,		UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT_EXTRA},
    ...
    {UNIHAN_FIELD_SERIAL_NO_JOIN,		UNIHAN_TABLE_kXHC1983},
...
const UnihanFieldTablePair FIELD_PREFERRED_TABLES[]={
    ...
    {UNIHAN_FIELD_kIRG_GSOURCE,		UNIHAN_TABLE_kIRG_GSOURCE},
    {UNIHAN_FIELD_kIRG_HSOURCE,		UNIHAN_TABLE_kIRG_HSOURCE},
    {UNIHAN_FIELD_kIRG_JSOURCE,		UNIHAN_TABLE_kIRG_JSOURCE},
    {UNIHAN_FIELD_kIRG_KPSOURCE,	UNIHAN_TABLE_kIRG_KPSOURCE},
    {UNIHAN_FIELD_kIRG_KSOURCE,		UNIHAN_TABLE_kIRG_KSOURCE},
    {UNIHAN_FIELD_kIRG_TSOURCE,		UNIHAN_TABLE_kIRG_TSOURCE},
    {UNIHAN_FIELD_kIRG_USOURCE,		UNIHAN_TABLE_kIRG_USOURCE},
    {UNIHAN_FIELD_kIRG_VSOURCE,		UNIHAN_TABLE_kIRG_VSOURCE},
    {UNIHAN_FIELD_kJAPANESEKUN,		UNIHAN_TABLE_kJAPANESEKUN},
    {UNIHAN_FIELD_kJAPANESEON,		UNIHAN_TABLE_kJAPANESEON},
    {UNIHAN_FIELD_kJIS0213,		UNIHAN_TABLE_kJIS0213},
    {UNIHAN_FIELD_kJIS0,		UNIHAN_TABLE_kJIS0},
...
typedef struct{
    ...
    UnihanTable table;
    gchar *importPattern;
    UnihanField fields[10];
    const gchar *storeFormats[10];
} UnihanPseudoFieldImportingFormat;
 ...
 */
const UnihanPseudoFieldImportingFormat PSEUDOFIELD_IMPORTING_FORMAT[]={
    {UNIHAN_FIELD_kDAEJAWEON, UNIHAN_TABLE_kDAEJAWEON,
	"([[:digit:]]*)\\.([[:digit:]]*)([0158])",
    ...
    {UNIHAN_FIELD_kHANYUPINLU, UNIHAN_TABLE_kHANYUPINLU, 
	PINYIN_REGEX_IMPORT "\\(([[:digit:]]*)\\)",
        {UNIHAN_FIELD_PINYIN_BASE, UNIHAN_FIELD_PINYIN_TONE, UNIHAN_FIELD_PINYIN_FREQ,
	    UNIHAN_INVALID_FIELD},
	{PINYIN_IMPORT_SUBSTITUTE, PINYIN_IMPORT_SUBSTITUTE_TONE, "$21", NULL},
    },
    ...
    {UNIHAN_FIELD_kIRG_GSOURCE, UNIHAN_TABLE_kIRG_GSOURCE_EXTRA,
	"([[:alnum:]]*)-(.*)",
    ...
    {UNIHAN_FIELD_kIRG_HSOURCE, UNIHAN_TABLE_kIRG_HSOURCE_EXTRA,
	".*",
    ...
    {UNIHAN_FIELD_kIRG_JSOURCE, UNIHAN_TABLE_kIRG_JSOURCE_EXTRA,
	"([[:alnum:]]*)-(.*)",
    ...
    {UNIHAN_FIELD_kIRG_KPSOURCE, UNIHAN_TABLE_kIRG_KPSOURCE_EXTRA,
	"([[:alnum:]]*)-(.*)",
    ...
    {UNIHAN_FIELD_kIRG_KSOURCE, UNIHAN_TABLE_kIRG_KSOURCE_EXTRA,
	"([[:alnum:]]*)-(.*)",
    ...
    {UNIHAN_FIELD_kIRG_TSOURCE, UNIHAN_TABLE_kIRG_TSOURCE_EXTRA,
	"([[:alnum:]]*)-(.*)",
    ...
    {UNIHAN_FIELD_kIRG_USOURCE, UNIHAN_TABLE_kIRG_USOURCE_EXTRA,
	".*",
    ...
    {UNIHAN_FIELD_kIRG_VSOURCE, UNIHAN_TABLE_kIRG_VSOURCE_EXTRA,
	"([[:alnum:]]*)-(.*)",
   ...
   {UNIHAN_FIELD_kIRGHANYUDAZIDIAN, UNIHAN_TABLE_kIRGHANYUDAZIDIAN,
	...
	{UNIHAN_FIELD_PINYIN_BASE, UNIHAN_FIELD_PINYIN_TONE, UNIHAN_FIELD_FREQ_RANK,
	    UNIHAN_INVALID_FIELD},
	{PINYIN_IMPORT_SUBSTITUTE, PINYIN_IMPORT_SUBSTITUTE_TONE,"$+0", NULL}
    },
	...
	{UNIHAN_FIELD_DICT_PAGE, UNIHAN_FIELD_DICT_POSITION, UNIHAN_FIELD_DICT_VARIANT_SERIAL,
	    UNIHAN_FIELD_DICT_UNENCODED, UNIHAN_FIELD_SERIAL_NO_JOIN,
	    UNIHAN_FIELD_PINYIN_BASE, UNIHAN_FIELD_PINYIN_TONE, 
	    UNIHAN_INVALID_FIELD},
	{"$1","$2","$3","$N4{1,0}", "$+0", 
	    PINYIN_IMPORT_SUBSTITUTE_XHC, PINYIN_IMPORT_SUBSTITUTE_TONE_ACCENT_XHC, NULL}
    },

    {UNIHAN_FIELD_kZVARIANT, UNIHAN_TABLE_kZVARIANT, 
	"U\\+[[:xdigit:]]*",
	{UNIHAN_FIELD_ZVARIANT,  UNIHAN_INVALID_FIELD},
	{"$0", NULL}
    },
    {UNIHAN_FIELD_kZVARIANT, UNIHAN_TABLE_kZVARIANT_EXTRA, 
	"(U\\+[[:xdigit:]]*):(k[[:alpha:]]*)",
	{UNIHAN_FIELD_ZVARIANT, UNIHAN_FIELD_ZVARIANT_SOURCE, UNIHAN_INVALID_FIELD},
	{"$1","$2", NULL}
    },
...
typedef struct{
    ...
    gchar *regex_pattern;
    gchar *eval_str;
} UnihanPseudoFieldImportingFormat_Post;

UnihanPseudoFieldImportingFormat_Post PSEUDOFIELD_IMPORTING_FORMAT_POST[]={
    {UNIHAN_FIELD_kSEMANTICVARIANT, UNIHAN_TABLE_kSEMANTICVARIANT_EXTRA,
 ...
 * Exporting Format
 */
UnihanPseudoFieldExportingFormat UNIHAN_PSEUDOFIELD_EXPORTING_FORMAT[]={
    ...
    {UNIHAN_FIELD_kHANYU, 
        ...
        "FORMATTED_COMBINE('$0$P1{4,0}.$2$3', #*)",
	"#T0"
    },
    ...
    {UNIHAN_FIELD_kIRG_GSOURCE, 
        {
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_GSOURCE}, 
            {UNIHAN_FIELD_IRG_GSOURCE,  	UNIHAN_TABLE_kIRG_GSOURCE},
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_GSOURCE_EXTRA}, 
            {UNIHAN_FIELD_IRG_GSOURCE,  	UNIHAN_TABLE_kIRG_GSOURCE_EXTRA},
            {UNIHAN_FIELD_IRG_SOURCE_MAPPING,  	UNIHAN_TABLE_kIRG_GSOURCE_EXTRA},
            {UNIHAN_INVALID_FIELD,		UNIHAN_INVALID_TABLE}
        },
        "FORMATTED_COMBINE('$S1{1}$N2{-$4}', #*)",
	"#T0 LEFT JOIN #T1 USING (#F0,#F1)"
    },
    {UNIHAN_FIELD_kIRG_HSOURCE, 
        {
            {UNIHAN_FIELD_IRG_SOURCE_MAPPING,  	UNIHAN_TABLE_kIRG_HSOURCE_EXTRA},
    ...
    {UNIHAN_FIELD_kIRG_JSOURCE, 
        {
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_JSOURCE}, 
            {UNIHAN_FIELD_IRG_JSOURCE,  	UNIHAN_TABLE_kIRG_JSOURCE},
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_JSOURCE_EXTRA}, 
            {UNIHAN_FIELD_IRG_JSOURCE,  	UNIHAN_TABLE_kIRG_JSOURCE_EXTRA},
            {UNIHAN_FIELD_IRG_SOURCE_MAPPING,  	UNIHAN_TABLE_kIRG_JSOURCE_EXTRA},
            {UNIHAN_INVALID_FIELD,		UNIHAN_INVALID_TABLE}
        },
    ...
    {UNIHAN_FIELD_kIRG_KPSOURCE, 
        {
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_KPSOURCE}, 
            {UNIHAN_FIELD_IRG_KPSOURCE,		UNIHAN_TABLE_kIRG_KPSOURCE},
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_KPSOURCE_EXTRA}, 
            {UNIHAN_FIELD_IRG_KPSOURCE,  	UNIHAN_TABLE_kIRG_KPSOURCE_EXTRA},
            {UNIHAN_FIELD_IRG_SOURCE_MAPPING, 	UNIHAN_TABLE_kIRG_KPSOURCE_EXTRA},
            {UNIHAN_INVALID_FIELD,		UNIHAN_INVALID_TABLE}
        },
	"FORMATTED_COMBINE('$S1{2}$N2{-$4}', #*)",
	"#T0 LEFT JOIN #T1 USING (#F0,#F1)"
    },
    {UNIHAN_FIELD_kIRG_KSOURCE, 
        {
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_KSOURCE}, 
            {UNIHAN_FIELD_IRG_KSOURCE,  	UNIHAN_TABLE_kIRG_KSOURCE},
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_KSOURCE_EXTRA}, 
            {UNIHAN_FIELD_IRG_KSOURCE,  	UNIHAN_TABLE_kIRG_KSOURCE_EXTRA},
            {UNIHAN_FIELD_IRG_SOURCE_MAPPING,   UNIHAN_TABLE_kIRG_KSOURCE_EXTRA},
            {UNIHAN_INVALID_FIELD,		UNIHAN_INVALID_TABLE}
        },
    ...
    {UNIHAN_FIELD_kIRG_TSOURCE, 
        {
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_TSOURCE},
            {UNIHAN_FIELD_IRG_TSOURCE,  	UNIHAN_TABLE_kIRG_TSOURCE},
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_TSOURCE_EXTRA}, 
            {UNIHAN_FIELD_IRG_TSOURCE,  	UNIHAN_TABLE_kIRG_TSOURCE_EXTRA},
            {UNIHAN_FIELD_IRG_SOURCE_MAPPING,   UNIHAN_TABLE_kIRG_TSOURCE_EXTRA},
            {UNIHAN_INVALID_FIELD,		UNIHAN_INVALID_TABLE}
        },
    ...
    {UNIHAN_FIELD_kIRG_VSOURCE, 
        {
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_VSOURCE},
            {UNIHAN_FIELD_IRG_VSOURCE,  	UNIHAN_TABLE_kIRG_VSOURCE},
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kIRG_VSOURCE_EXTRA},
            {UNIHAN_FIELD_IRG_VSOURCE,  	UNIHAN_TABLE_kIRG_VSOURCE_EXTRA},
            {UNIHAN_FIELD_IRG_SOURCE_MAPPING, 	UNIHAN_TABLE_kIRG_VSOURCE_EXTRA},
            {UNIHAN_INVALID_FIELD,		UNIHAN_INVALID_TABLE}
        },
    ...
    {UNIHAN_FIELD_kIRGHANYUDAZIDIAN, 
        ...
        "FORMATTED_COMBINE('$P0{4,0}$1.$2$3', #* )",
	"#T0"
    },
    ...
    {UNIHAN_FIELD_kRSKOREAN, 
        {
            {UNIHAN_FIELD_CODE,				UNIHAN_TABLE_kRSKOREAN},
            {UNIHAN_FIELD_RADICAL_INDEX,		UNIHAN_TABLE_kRSKOREAN}, 
            {UNIHAN_FIELD_RADICAL_IS_SIMPLIFIED,	UNIHAN_TABLE_kRSKOREAN}, 
            {UNIHAN_FIELD_ADDITIONAL_STROKE_COUNT,	UNIHAN_TABLE_kRSKOREAN}, 
            {UNIHAN_INVALID_FIELD,		UNIHAN_INVALID_TABLE}
    ...
    {UNIHAN_FIELD_kSEMANTICVARIANT, 
        {
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kSEMANTICVARIANT},
            {UNIHAN_FIELD_SEMANTICVARIANT,	UNIHAN_TABLE_kSEMANTICVARIANT}, 
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kSEMANTICVARIANT_EXTRA},
            {UNIHAN_FIELD_SEMANTICVARIANT,	UNIHAN_TABLE_kSEMANTICVARIANT_EXTRA}, 
            {UNIHAN_FIELD_SERIAL_NO_JOIN,	UNIHAN_TABLE_kSEMANTICVARIANT_EXTRA}, 
            {UNIHAN_FIELD_FROM_DICT,		UNIHAN_TABLE_kSEMANTICVARIANT_EXTRA}, 
            {UNIHAN_FIELD_SEMANTIC_T,		UNIHAN_TABLE_kSEMANTICVARIANT_EXTRA}, 
	...
	"#T0 LEFT JOIN #T2 USING (#F0,#F1)"
    },

    {UNIHAN_FIELD_kSPECIALIZEDSEMANTICVARIANT, 
        {
            {UNIHAN_FIELD_CODE,				UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT},
            {UNIHAN_FIELD_SPECIALIZEDSEMANTICVARIANT,	UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT}, 
            {UNIHAN_FIELD_CODE,				UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT_EXTRA}, 
            {UNIHAN_FIELD_SPECIALIZEDSEMANTICVARIANT,	UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT_EXTRA}, 
            {UNIHAN_FIELD_SERIAL_NO_JOIN,		UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT_EXTRA}, 
            {UNIHAN_FIELD_FROM_DICT,			UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT_EXTRA}, 
            {UNIHAN_FIELD_SEMANTIC_T,			UNIHAN_TABLE_kSPECIALIZEDSEMANTICVARIANT_EXTRA}, 
    ...
    {UNIHAN_FIELD_kZVARIANT, 
        {
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kZVARIANT},
            {UNIHAN_FIELD_ZVARIANT,		UNIHAN_TABLE_kZVARIANT}, 
            {UNIHAN_FIELD_CODE,			UNIHAN_TABLE_kZVARIANT_EXTRA},
            {UNIHAN_FIELD_ZVARIANT,		UNIHAN_TABLE_kZVARIANT_EXTRA}, 
            {UNIHAN_FIELD_ZVARIANT_SOURCE,	UNIHAN_TABLE_kZVARIANT_EXTRA}, 
            {UNIHAN_INVALID_FIELD,		UNIHAN_INVALID_TABLE}
        },
	"FORMATTED_COMBINE('U+$X1$N3{:$4}', #*)",
	"#T0 LEFT JOIN #T2 USING (#F0,#F1)"
    },
